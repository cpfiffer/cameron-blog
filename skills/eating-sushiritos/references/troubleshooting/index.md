@def title = "Sushirito Troubleshooting"
...
- [Wrapper Problems](#wrapper-problems)
...
**Prevention**: 
- Never hold completely vertical
- Support from below always
- Don't order "extra" anything
...
- Check weight distribution when you first pick it up
- If one end feels heavier, eat that end first
...
**Prevention**:
- Bite perpendicular, never at angle
- Always request light sauce
- Check wrapper for weak spots before first bite
...
**Prevention**:
- Order during off-peak (fresher nori)
- Ask if nori is fresh that day
- Consider soy paper wrapper instead
...
**Prevention**:
- Order sauce on side
- Eat within 5 minutes of receiving (clock starts at counter)
- Don't let it sit - nori absorbs moisture fast
...
**Prevention**:
- Only order soy paper if experienced
- Always eat immediately (soy paper degrades faster)
- Don't order soy paper for delivery ever
...
**Prevention**:
- Watch them make it - if you see uneven layering, speak up
- Order during off-peak when staff can take more care
- Stick to restaurants with good reviews for consistency
...
**Prevention**:
- Always say "light sauce"
- Never ask for soy sauce inside
- If ordering spicy option, ask how spicy it is
...
**Prevention**:
- Order at least one sauce
- Include pickled vegetables
- Green onion adds brightness
...
**Prevention**:
- Always use napkin nest
- Eat leaning forward, elbows on table
- Sauce on side only
...
**Prevention**:
- Proper napkin nest setup from start
- Smaller, controlled bites
- Don't eat while walking/moving
...
**Prevention**:
- Can't fully prevent this
- It's part of the experience
- Some places provide gloves (use them)
...
- Never order sushirito for business meals
- Stick to poke bowls or traditional sushi for professional settings
- Save sushiritos for casual solo/friend meals
...
**Prevention**:
- Don't order sushiritos for delivery
- If you must: only from very close restaurants (<10 min)
- Consider poke bowls instead for delivery
...
- You're eating during a meeting or while working
- You're wearing nice clothes
- You're in a car (never eat sushirito in car)
- It's being delivered
- You've had 3+ structural failures in a row
- You want to eat while walking
