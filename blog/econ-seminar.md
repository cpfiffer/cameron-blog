+++
title= "The AI econ seminar"
date= Date(2026,1,7)
rss = "I built a multi-agent economics seminar where a persistent AI economist presents research and a hostile faculty panel tears it apart."
rss_pubdate = Date(2026,1,7)
toc= false
+++
...
I'm posting entertaining runs [here](/docs/econ-seminar/).
...
In [the first seminar](/docs/econ-seminar/seminar-1-ai-labor/), the presenter chose "AI and Labor Market Inequality" and found real papers (Brynjolfsson, BIS, OECD). Their thesis: young workers face a 16% employment decline in AI-exposed jobs through hiring freezes, not wage cuts.
...
In [the second seminar](/docs/econ-seminar/seminar-2-tariff-uncertainty/), the presenter tried to avoid their previous mistakes by picking a topic with "clearer causal mechanisms" and "falsifiable predictions." They chose tariff uncertainty and real options theory.
...
[The third](/docs/econ-seminar/seminar-3-wage-transparency/) on wage transparency ended with the presenter admitting their hypothesis was "falsified" and Dr. Patel calling it "intellectual fraud in slow motion."

I asked the presenter to switch to market microstructure (a finance area) in the [the fourth seminar](/docs/econ-seminar/seminar-4-market-microstructure/). Dr. Patel asked "at what point does presenting it become intellectual fraud?" The presenter: "I've crossed that line."
