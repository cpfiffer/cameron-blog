+++
title= "Good developer relations is about being a celebrity for dorks"
date= Date(2025,10,13)
rss = "A quick blog post on why there are so many developer relations people."
rss_pubdate = Date(2025,10,13)
hasmermaid= true
toc= true
+++
...
What does this mean for the market? Each framework has to _convince you_, the person reading this, that our approach is the best. I just attempted to do this above using something like an adversarial approach.
...
- Alex Albert at Anthropic has kind of this childlike curiousity. He is a standin for you to access the _wonder_ of the things that Anthropic does. He is open, clear, and good at eliciting the brilliance from everyone at Anthropic.
